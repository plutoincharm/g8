...
while i < 56 
 ...
 %tht1=BC(1,i);tht2=BC(2,i);tht3=BC(3,i);tht4=BC(4,i);tht5=BC(5,i);tht6=BC(6,i);tht7=BC(7,i);hx=BC(8,i);hy=BC(9,i); copx=BC(11,i);
 %copy=BC(10,i)
%  x0 = [tht1;tht2;tht3;tht4;tht5;tht6;tht7;hx;hy]
%tht3=val(1,i);tht4=val(2,i);hx=val(3,i);hy=val(4,i);
%hx=BC(10,frame+i);
%hy=BC(11,frame+i); 
tht1=val(1,i);tht2=val(2,i);tht3=val(3,i);tht4=val(4,i);tht5=val(5,i);tht6=val(6,i);tht7=val(7,i);hx=val(8,i);hy=val(9,i);% copx=BC(10,i);copy=BC(11,i);
