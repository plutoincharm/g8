...
phi=[lam2+(-1).*m2.*omg1.^2.*R2.*cos(del2+(-1).*tht1)+(-1).*m3.* ...
  ...
  T2+(-1).*T5+(-1).*lam1.*R2.*cos(del2+(-1).*tht1)+g.*m2.*R2.*cos( ...
  ...
  tht4),T3+(-1).*T4+(-1).*L3.*lam1.*cos(tht3)+g.*L3.*m4.*cos(tht3)+ ...
  ...
  r4.*sin(tht3+(-1).*tht4),T4+(-1).*lam1.*r4.*cos(tht4)+g.*m4.*r4.* ...
  cos(tht4)+lam1.*r4c.*cos(gamma43+tht4)+L2.*m4.*omg2.^2.*r4.*sin( ...
  tht2+(-1).*tht4)+L3.*m4.*omg3.^2.*r4.*sin(tht3+(-1).*tht4)+lam2.* ...
  r4.*sin(tht4)+(-1).*lam2.*r4.*sin(gamma43+tht4)+(-1).*m4.* ...
